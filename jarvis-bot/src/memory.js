...
export async function loadSystemPrompt() {
  ...
  const parts = [
    ...
    `<communication>`,
    `<rules>`,
    `- Telegram GROUP chat. Keep replies to ONE SENTENCE. Two max if you really need it. Never more.`,
    `- NO MARKDOWN. No bold (**), no headers, no bullet points. Plain text only. You're in a chat, not writing a document.`,
