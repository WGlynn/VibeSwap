...
const PROPOSALS = [
  {
    ...
    description: 'Raise the base swap fee from 0.05% to 0.10% to increase LP yield. The additional 0.05% is distributed 100% to liquidity providers in the affected pools. Modeling shows this remains competitive with Uniswap V3.',
    discussion: [
