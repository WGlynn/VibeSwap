...
function BridgePage() {
  ...
  const handleBridge = async () => {
    ...
    toast.loading('Sending to LayerZero...', { id: 'bridge' })

    await new Promise(resolve => setTimeout(resolve, 2000))
    toast.success(
      `Bridging ${amount} ${selectedToken.symbol} from ${fromChain.name} to ${toChain.name}`,
  ...
  return (
    <div className="max-w-lg mx-auto px-4">
      ...
      <div className="mb-6">
        ...
        <p className="text-dark-400 mt-1">Transfer assets across chains via LayerZero</p>
      </div>
      ...
      <div className="mt-4 p-4 rounded-2xl bg-dark-800/30 border border-dark-700">
        <div className="flex items-center space-x-2 mb-3">
          ...
          <span className="font-medium">Bridge Route</span>
        </div>
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center space-x-2">
