...
const PROPOSAL = {
  ...
  description: [
    'This proposal seeks to increase the insurance pool allocation from the current 5% of priority bid revenue to 8%. The insurance pool serves as the first line of defense against impermanent loss for liquidity providers, and analysis of the past 90 days shows that the current allocation is insufficient to cover peak drawdown events. Raising the allocation to 8% would bring the pool reserves to approximately $2.1M, covering a 3-sigma tail event with 99.7% confidence.',
