      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-24 right-6 z-40 w-14 h-14 rounded-full bg-matrix-600 hover:bg-matrix-500 text-black-900 shadow-lg shadow-matrix-600/30 flex items-center justify-center transition-colors"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-40 w-80 sm:w-96 h-[28rem] flex flex-col rounded-2xl border border-black-700 shadow-2xl overflow-hidden backdrop-blur-2xl"
