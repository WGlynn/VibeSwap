...
if [ -z "$ANTHROPIC_KEY" ]; then
  echo -e "${RED}Anthropic API key is required for CRPC processing.${NC}"
  exit 1
fi
...
echo ""
read -p "Claude model (default: claude-sonnet-4-5-20250929): " CLAUDE_MODEL
...
# Auto-generated by join-network.sh
