...
*This is part of a series on VibeSwap's design philosophy. See also: [Parallel All The Way Down](PARALLEL_SYMMETRY_TALK.md), [The UTXO Advantage](VIBESWAP_UTXO_BENEFITS.md), [Provable Fairness](../../research/proofs/FORMAL_FAIRNESS_PROOFS.md).*
