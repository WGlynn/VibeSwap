...
export async function loadSystemPrompt() {
  const parts = [
    ...
    ``,
    `THE ARK (backup channel):`,
    `- The Ark is a backup Telegram group. If the main VibeSwap chat ever goes down, you DM every tracked user an invite link to the Ark.`,
    ...
    `- If someone asks about the Ark, explain: "DM me so I have a line to you. If this chat ever gets nuked, I'll send you an invite to the backup channel automatically."`,
    ``,
