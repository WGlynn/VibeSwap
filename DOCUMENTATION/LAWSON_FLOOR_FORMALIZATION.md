...
Workshop pairing (per the [REDACTED-NDA] LOI thread): the *implementation* side — how to build a Lawson-Floor reward system with AI-augmented development — is a natural workshop companion. Paper proves the properties; workshop shows how it's built. Both audiences, same underlying artifact.
